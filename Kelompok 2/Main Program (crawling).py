...
#latitude = 51.5073219    # geographical centre of search London
#longitude = -0.1276474  # geographical centre of search London
latitude = -6.1753942    # geographical centre of search Jakarta
longitude = 106.827183  # geographical centre of search Jakarta
max_range = 1             # search range in kilometres
num_results = 3000       # minimum results to obtain
outfile = "coba4.csv"
...
#-----------------------------------------------------------------------
row = [ "user","date", "text", "latitude", "longitude" ]
